...
The copy operation from container to host will work, provided the user calls `sync(1)` prior to the copy to make sure any outstanding cached data is written to the block device.
